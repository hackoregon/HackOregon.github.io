...
BLOG_AUTHOR = "M. Edward (Ed) Borasky"  # (translatable)
BLOG_TITLE = "HackOregon Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://hackoregon.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://hackoregon.github.io/"
BLOG_EMAIL = "znmeb@znmeb.net"
BLOG_DESCRIPTION = "HackOregon: Making Public Information, Public Knowledge"  # (translatable)
